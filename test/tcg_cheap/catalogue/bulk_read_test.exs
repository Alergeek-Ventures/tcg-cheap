defmodule TcgCheap.Catalogue.BulkReadTest do
  ...
  test "bulk printing read returns requested cards with local set and bulk valuation" do
    suffix = token("bulk")
    ...
    assert first_result.cardmarket_bulk_v1_current_valuation.value_eur == Decimal.new("1.25")
