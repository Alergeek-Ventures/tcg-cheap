...
defmodule TcgCheapWeb.Admin.OperationsLiveTest do
  ...
  test "authenticated page exposes operations structure and navigation", %{conn: conn} do
    ...
    assert has_element?(view, "#admin-catalogue a[href='/admin/review']")
    assert has_element?(view, "#admin-catalogue a[href='/admin/catalogue/products']")
    assert has_element?(view, "#admin-catalogue a[href='/admin/operations']")
    assert has_element?(view, "#admin-catalogue-sign-out")
    assert has_element?(view, "#operations-accounting-notes")
    ...
    assert has_element?(view, "#operations-provider-details summary", "Provider details")
    assert has_element?(view, "#operations-run-details summary", "Recent runs")
    assert has_element?(view, "#operations-job-details summary", "Recent jobs")
    assert has_element?(view, "#operations-buying-model-details summary", "Model details")
    refute has_element?(view, "#operations-provider-details[open]")
    refute has_element?(view, "#operations-run-details[open]")
    refute has_element?(view, "#operations-job-details[open]")
    refute has_element?(view, "#operations-buying-model-details[open]")
