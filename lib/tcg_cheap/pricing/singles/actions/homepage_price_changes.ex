  ...
  defp query(params) do
    Repo.query(
      ...
      WHERE e.newest_current
        AND abs(((e.current_value_eur - e.start_value_eur) / NULLIF(e.start_value_eur, 0)) * 100) >= 5
      ORDER BY abs(((e.current_value_eur - e.start_value_eur) / NULLIF(e.start_value_eur, 0)) * 100) DESC,
        e.current_fetched_at DESC, cp.tcgdex_id ASC
      LIMIT LEAST($3::integer, 6)
      """,
      params
    )
  end
