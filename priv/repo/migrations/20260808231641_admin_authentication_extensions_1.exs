defmodule TcgCheap.Repo.Migrations.AdminAuthenticationExtensions1 do
  @moduledoc """
  ...
  def down do
    # The Ash functions and pg_trgm extension predate this migration, while citext may be
    # shared by other schemas. Rolling back this schema addition must not remove shared objects.
    :ok
  end
end
