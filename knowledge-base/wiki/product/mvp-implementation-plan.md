...
6. **Automated suite current; real-data validation remains incomplete:** Canonical validation passes 748 tests and all static gates. Bounded TCGdex live discovery succeeds; a complete production catalogue import, accumulated real history, search collision tuning, sealed observations/stock transitions, and Polish-market buying-model validation remain outstanding.
