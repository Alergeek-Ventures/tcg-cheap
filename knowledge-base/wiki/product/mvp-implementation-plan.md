...
6. **Automated suite current; real-data validation remains blocked:** Canonical validation passes 743 tests and all static gates. Production catalogue import, accumulated real history, search collision tuning, sealed observations/stock transitions, and Polish-market buying-model validation still require approved/reliable sources and real non-fabricated evidence.
