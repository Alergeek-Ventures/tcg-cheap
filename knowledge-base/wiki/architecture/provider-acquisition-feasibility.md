...
3. Complete automatic current-snapshot replacement/archive orchestration, then wire background Oban acquisition and UI integration; keep the adapter outside request-path fetches.
