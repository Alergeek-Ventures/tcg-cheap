...
8. **Complete:** the minimal Home correction retains approved colors, fonts, and warm square direction while reducing density and using plain-language CTAs. The shared external focus-preserving autocomplete and URL-only EUR/PLN trade/share surface are implemented and browser/test validated. Sealed remains unfinished and is the next Phase 4 roadmap phase.
