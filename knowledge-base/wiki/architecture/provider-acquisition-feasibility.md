...
8. **Complete:** the minimal Home correction retains approved colors, fonts, and warm square direction while reducing density and using plain-language CTAs. The shared external focus-preserving autocomplete and URL-only EUR trade foundation are implemented and browser/test validated. Remaining trade blockers are NBP EUR/PLN conversion and explicit share/copy controls; sealed remains unfinished.
