...
8. **Complete:** the minimal Home correction retains approved colors, fonts, and warm square direction while reducing density and using plain-language CTAs. The focus-preserving autocomplete correction is implemented and browser/test validated. Next prioritize Phase 3 trade foundations and broader roadmap work. Sealed and trade remain unfinished.
